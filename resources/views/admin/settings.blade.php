                        ...
                        <ul class="nav nav-pills flex-column mr-lg-3 wmin-lg-250 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a href="#cacheSettings" class="nav-link" data-toggle="tab">
                                    <i
                                        class="icon-database-refresh mr-2 custom-color-{{ rand(1,8) }} settings-icon"></i>
                                    Cache Settings
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            <div class="tab-pane fade show active" id="generalSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="storeUrl" value="{{ config('setting.storeUrl') }}" placeholder="Enter website URL like: https://yourdomain.com" readonly="readonly">
                                    </div>
                                </div> 
                                --}}
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="storeName"
                                            value="{{ config('setting.storeName') }}" placeholder="Enter Store Name">
                                        <span class="help-text small"> To change the Progressive Web Application name, refer to
                                            this <a href="https://docs.foodomaa.com/configurations/pwa-configurations"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="currencyId" class="form-control form-control-lg select">
                                            <option value="AED" @if(config('setting.currencyId')=="AED" ) selected @endif>
                                                AED</option>
                                            <option value="AFN" @if(config('setting.currencyId')=="AFN" ) selected @endif>
                                                AFN</option>
                                            <option value="ALL" @if(config('setting.currencyId')=="ALL" ) selected @endif>
                                                ALL</option>
                                            <option value="AMD" @if(config('setting.currencyId')=="AMD" ) selected @endif>
                                                AMD</option>
                                            <option value="ANG" @if(config('setting.currencyId')=="ANG" ) selected @endif>
                                                ANG</option>
                                            <option value="ANG" @if(config('setting.currencyId')=="ANG" ) selected @endif>
                                                ANG</option>
                                            <option value="AOA" @if(config('setting.currencyId')=="AOA" ) selected @endif>
                                                AOA</option>
                                            <option value="ARS" @if(config('setting.currencyId')=="ARS" ) selected @endif>
                                                ARS</option>
                                            <option value="AUD" @if(config('setting.currencyId')=="AUD" ) selected @endif>
                                                AUD</option>
                                            <option value="AWG" @if(config('setting.currencyId')=="AWG" ) selected @endif>
                                                AWG</option>
                                            <option value="AZN" @if(config('setting.currencyId')=="AZN" ) selected @endif>
                                                AZN</option>
                                            <option value="BAM" @if(config('setting.currencyId')=="BAM" ) selected @endif>
                                                BAM</option>
                                            <option value="BBD" @if(config('setting.currencyId')=="BBD" ) selected @endif>
                                                BBD</option>
                                            <option value="BDT" @if(config('setting.currencyId')=="BDT" ) selected @endif>
                                                BDT</option>
                                            <option value="BGN" @if(config('setting.currencyId')=="BGN" ) selected @endif>
                                                BGN</option>
                                            <option value="BHD" @if(config('setting.currencyId')=="BHD" ) selected @endif>
                                                BHD</option>
                                            <option value="BIF" @if(config('setting.currencyId')=="BIF" ) selected @endif>
                                                BIF</option>
                                            <option value="BMD" @if(config('setting.currencyId')=="BMD" ) selected @endif>
                                                BMD</option>
                                            <option value="BND" @if(config('setting.currencyId')=="BND" ) selected @endif>
                                                BND</option>
                                            <option value="BOB" @if(config('setting.currencyId')=="BOB" ) selected @endif>
                                                BOB</option>
                                            <option value="BOV" @if(config('setting.currencyId')=="BOV" ) selected @endif>
                                                BOV</option>
                                            <option value="BRL" @if(config('setting.currencyId')=="BRL" ) selected @endif>
                                                BRL</option>
                                            <option value="BSD" @if(config('setting.currencyId')=="BSD" ) selected @endif>
                                                BSD</option>
                                            <option value="BTN" @if(config('setting.currencyId')=="BTN" ) selected @endif>
                                                BTN</option>
                                            <option value="BWP" @if(config('setting.currencyId')=="BWP" ) selected @endif>
                                                BWP</option>
                                            <option value="BYN" @if(config('setting.currencyId')=="BYN" ) selected @endif>
                                                BYN</option>
                                            <option value="BZD" @if(config('setting.currencyId')=="BZD" ) selected @endif>
                                                BZD</option>
                                            <option value="CAD" @if(config('setting.currencyId')=="CAD" ) selected @endif>
                                                CAD</option>
                                            <option value="CDF" @if(config('setting.currencyId')=="CDF" ) selected @endif>
                                                CDF</option>
                                            <option value="CHE" @if(config('setting.currencyId')=="CHE" ) selected @endif>
                                                CHE</option>
                                            <option value="CHF" @if(config('setting.currencyId')=="CHF" ) selected @endif>
                                                CHF</option>
                                            <option value="CHW" @if(config('setting.currencyId')=="CHW" ) selected @endif>
                                                CHW</option>
                                            <option value="CLF" @if(config('setting.currencyId')=="CLF" ) selected @endif>
                                                CLF</option>
                                            <option value="CLP" @if(config('setting.currencyId')=="CLP" ) selected @endif>
                                                CLP</option>
                                            <option value="CNY" @if(config('setting.currencyId')=="CNY" ) selected @endif>
                                                CNY</option>
                                            <option value="COP" @if(config('setting.currencyId')=="COP" ) selected @endif>
                                                COP</option>
                                            <option value="COU" @if(config('setting.currencyId')=="COU" ) selected @endif>
                                                COU</option>
                                            <option value="CRC" @if(config('setting.currencyId')=="CRC" ) selected @endif>
                                                CRC</option>
                                            <option value="CUC" @if(config('setting.currencyId')=="CUC" ) selected @endif>
                                                CUC</option>
                                            <option value="CVE" @if(config('setting.currencyId')=="CVE" ) selected @endif>
                                                CVE</option>
                                            <option value="CZK" @if(config('setting.currencyId')=="CZK" ) selected @endif>
                                                CZK</option>
                                            <option value="DJF" @if(config('setting.currencyId')=="DJF" ) selected @endif>
                                                DJF</option>
                                            <option value="DKK" @if(config('setting.currencyId')=="DKK" ) selected @endif>
                                                DKK</option>
                                            <option value="DOP" @if(config('setting.currencyId')=="DOP" ) selected @endif>
                                                DOP</option>
                                            <option value="DZD" @if(config('setting.currencyId')=="DZD" ) selected @endif>
                                                DZD</option>
                                            <option value="EGP" @if(config('setting.currencyId')=="EGP" ) selected @endif>
                                                EGP</option>
                                            <option value="ERN" @if(config('setting.currencyId')=="ERN" ) selected @endif>
                                                ERN</option>
                                            <option value="ETB" @if(config('setting.currencyId')=="ETB" ) selected @endif>
                                                ETB</option>
                                            <option value="EUR" @if(config('setting.currencyId')=="EUR" ) selected @endif>
                                                EUR</option>
                                            <option value="FJD" @if(config('setting.currencyId')=="FJD" ) selected @endif>
                                                FJD</option>
                                            <option value="FKP" @if(config('setting.currencyId')=="FKP" ) selected @endif>
                                                FKP</option>
                                            <option value="GBP" @if(config('setting.currencyId')=="GBP" ) selected @endif>
                                                GBP</option>
                                            <option value="GEL" @if(config('setting.currencyId')=="GEL" ) selected @endif>
                                                GEL</option>
                                            <option value="GHS" @if(config('setting.currencyId')=="GHS" ) selected @endif>
                                                GHS</option>
                                            <option value="GIP" @if(config('setting.currencyId')=="GIP" ) selected @endif>
                                                GIP</option>
                                            <option value="GMD" @if(config('setting.currencyId')=="GMD" ) selected @endif>
                                                GMD</option>
                                            <option value="GNF" @if(config('setting.currencyId')=="GNF" ) selected @endif>
                                                GNF</option>
                                            <option value="GTQ" @if(config('setting.currencyId')=="GTQ" ) selected @endif>
                                                GTQ</option>
                                            <option value="GYD" @if(config('setting.currencyId')=="GYD" ) selected @endif>
                                                GYD</option>
                                            <option value="HKD" @if(config('setting.currencyId')=="HKD" ) selected @endif>
                                                HKD</option>
                                            <option value="HNL" @if(config('setting.currencyId')=="HNL" ) selected @endif>
                                                HNL</option>
                                            <option value="HRK" @if(config('setting.currencyId')=="HRK" ) selected @endif>
                                                HRK</option>
                                            <option value="HTG" @if(config('setting.currencyId')=="HTG" ) selected @endif>
                                                HTG</option>
                                            <option value="HUF" @if(config('setting.currencyId')=="HUF" ) selected @endif>
                                                HUF</option>
                                            <option value="IDR" @if(config('setting.currencyId')=="IDR" ) selected @endif>
                                                IDR</option>
                                            <option value="ILS" @if(config('setting.currencyId')=="ILS" ) selected @endif>
                                                ILS</option>
                                            <option value="INR" @if(config('setting.currencyId')=="INR" ) selected @endif>
                                                INR</option>
                                            <option value="IQD" @if(config('setting.currencyId')=="IQD" ) selected @endif>
                                                IQD</option>
                                            <option value="IRR" @if(config('setting.currencyId')=="IRR" ) selected @endif>
                                                IRR</option>
                                            <option value="ISK" @if(config('setting.currencyId')=="ISK" ) selected @endif>
                                                ISK</option>
                                            <option value="JMD" @if(config('setting.currencyId')=="JMD" ) selected @endif>
                                                JMD</option>
                                            <option value="JOD" @if(config('setting.currencyId')=="JOD" ) selected @endif>
                                                JOD</option>
                                            <option value="JPY" @if(config('setting.currencyId')=="JPY" ) selected @endif>
                                                JPY</option>
                                            <option value="KES" @if(config('setting.currencyId')=="KES" ) selected @endif>
                                                KES</option>
                                            <option value="KGS" @if(config('setting.currencyId')=="KGS" ) selected @endif>
                                                KGS</option>
                                            <option value="KHR" @if(config('setting.currencyId')=="KHR" ) selected @endif>
                                                KHR</option>
                                            <option value="KMF" @if(config('setting.currencyId')=="KMF" ) selected @endif>
                                                KMF</option>
                                            <option value="KPW" @if(config('setting.currencyId')=="KPW" ) selected @endif>
                                                KPW</option>
                                            <option value="KRW" @if(config('setting.currencyId')=="KRW" ) selected @endif>
                                                KRW</option>
                                            <option value="KWD" @if(config('setting.currencyId')=="KWD" ) selected @endif>
                                                KWD</option>
                                            <option value="KYD" @if(config('setting.currencyId')=="KYD" ) selected @endif>
                                                KYD</option>
                                            <option value="KZT" @if(config('setting.currencyId')=="KZT" ) selected @endif>
                                                KZT</option>
                                            <option value="LAK" @if(config('setting.currencyId')=="LAK" ) selected @endif>
                                                LAK</option>
                                            <option value="LBP" @if(config('setting.currencyId')=="LBP" ) selected @endif>
                                                LBP</option>
                                            <option value="LKR" @if(config('setting.currencyId')=="LKR" ) selected @endif>
                                                LKR</option>
                                            <option value="LRD" @if(config('setting.currencyId')=="LRD" ) selected @endif>
                                                LRD</option>
                                            <option value="LSL" @if(config('setting.currencyId')=="LSL" ) selected @endif>
                                                LSL</option>
                                            <option value="LYD" @if(config('setting.currencyId')=="LYD" ) selected @endif>
                                                LYD</option>
                                            <option value="MAD" @if(config('setting.currencyId')=="MAD" ) selected @endif>
                                                MAD</option>
                                            <option value="MDL" @if(config('setting.currencyId')=="MDL" ) selected @endif>
                                                MDL</option>
                                            <option value="MGA" @if(config('setting.currencyId')=="MGA" ) selected @endif>
                                                MGA</option>
                                            <option value="MKD" @if(config('setting.currencyId')=="MKD" ) selected @endif>
                                                MKD</option>
                                            <option value="MMK" @if(config('setting.currencyId')=="MMK" ) selected @endif>
                                                MMK</option>
                                            <option value="MNT" @if(config('setting.currencyId')=="MNT" ) selected @endif>
                                                MNT</option>
                                            <option value="MOP" @if(config('setting.currencyId')=="MOP" ) selected @endif>
                                                MOP</option>
                                            <option value="MRU" @if(config('setting.currencyId')=="MRU" ) selected @endif>
                                                MRU</option>
                                            <option value="MUR" @if(config('setting.currencyId')=="MUR" ) selected @endif>
                                                MUR</option>
                                            <option value="MVR" @if(config('setting.currencyId')=="MVR" ) selected @endif>
                                                MVR</option>
                                            <option value="MWK" @if(config('setting.currencyId')=="MWK" ) selected @endif>
                                                MWK</option>
                                            <option value="MXN" @if(config('setting.currencyId')=="MXN" ) selected @endif>
                                                MXN</option>
                                            <option value="MXV" @if(config('setting.currencyId')=="MXV" ) selected @endif>
                                                MXV</option>
                                            <option value="MYR" @if(config('setting.currencyId')=="MYR" ) selected @endif>
                                                MYR</option>
                                            <option value="MZN" @if(config('setting.currencyId')=="MZN" ) selected @endif>
                                                MZN</option>
                                            <option value="NAD" @if(config('setting.currencyId')=="NAD" ) selected @endif>
                                                NAD</option>
                                            <option value="NGN" @if(config('setting.currencyId')=="NGN" ) selected @endif>
                                                NGN</option>
                                            <option value="NIO" @if(config('setting.currencyId')=="NIO" ) selected @endif>
                                                NIO</option>
                                            <option value="NOK" @if(config('setting.currencyId')=="NOK" ) selected @endif>
                                                NOK</option>
                                            <option value="NPR" @if(config('setting.currencyId')=="NPR" ) selected @endif>
                                                NPR</option>
                                            <option value="NZD" @if(config('setting.currencyId')=="NZD" ) selected @endif>
                                                NZD</option>
                                            <option value="OMR" @if(config('setting.currencyId')=="OMR" ) selected @endif>
                                                OMR</option>
                                            <option value="PAB" @if(config('setting.currencyId')=="PAB" ) selected @endif>
                                                PAB</option>
                                            <option value="PEN" @if(config('setting.currencyId')=="PEN" ) selected @endif>
                                                PEN</option>
                                            <option value="PGK" @if(config('setting.currencyId')=="PGK" ) selected @endif>
                                                PGK</option>
                                            <option value="PHP" @if(config('setting.currencyId')=="PHP" ) selected @endif>
                                                PHP</option>
                                            <option value="PKR" @if(config('setting.currencyId')=="PKR" ) selected @endif>
                                                PKR</option>
                                            <option value="PLN" @if(config('setting.currencyId')=="PLN" ) selected @endif>
                                                PLN</option>
                                            <option value="PYG" @if(config('setting.currencyId')=="PYG" ) selected @endif>
                                                PYG</option>
                                            <option value="QAR" @if(config('setting.currencyId')=="QAR" ) selected @endif>
                                                QAR</option>
                                            <option value="RON" @if(config('setting.currencyId')=="RON" ) selected @endif>
                                                RON</option>
                                            <option value="RSD" @if(config('setting.currencyId')=="RSD" ) selected @endif>
                                                RSD</option>
                                            <option value="RUB" @if(config('setting.currencyId')=="RUB" ) selected @endif>
                                                RUB</option>
                                            <option value="RWF" @if(config('setting.currencyId')=="RWF" ) selected @endif>
                                                RWF</option>
                                            <option value="SAR" @if(config('setting.currencyId')=="SAR" ) selected @endif>
                                                SAR</option>
                                            <option value="SBD" @if(config('setting.currencyId')=="SBD" ) selected @endif>
                                                SBD</option>
                                            <option value="SCR" @if(config('setting.currencyId')=="SCR" ) selected @endif>
                                                SCR</option>
                                            <option value="SDG" @if(config('setting.currencyId')=="SDG" ) selected @endif>
                                                SDG</option>
                                            <option value="SEK" @if(config('setting.currencyId')=="SEK" ) selected @endif>
                                                SEK</option>
                                            <option value="SGD" @if(config('setting.currencyId')=="SGD" ) selected @endif>
                                                SGD</option>
                                            <option value="SHP" @if(config('setting.currencyId')=="SHP" ) selected @endif>
                                                SHP</option>
                                            <option value="SLL" @if(config('setting.currencyId')=="SLL" ) selected @endif>
                                                SLL</option>
                                            <option value="SOS" @if(config('setting.currencyId')=="SOS" ) selected @endif>
                                                SOS</option>
                                            <option value="SRD" @if(config('setting.currencyId')=="SRD" ) selected @endif>
                                                SRD</option>
                                            <option value="SSP" @if(config('setting.currencyId')=="SSP" ) selected @endif>
                                                SSP</option>
                                            <option value="STN" @if(config('setting.currencyId')=="STN" ) selected @endif>
                                                STN</option>
                                            <option value="SVC" @if(config('setting.currencyId')=="SVC" ) selected @endif>
                                                SVC</option>
                                            <option value="SYP" @if(config('setting.currencyId')=="SYP" ) selected @endif>
                                                SYP</option>
                                            <option value="SZL" @if(config('setting.currencyId')=="SZL" ) selected @endif>
                                                SZL</option>
                                            <option value="THB" @if(config('setting.currencyId')=="THB" ) selected @endif>
                                                THB</option>
                                            <option value="TJS" @if(config('setting.currencyId')=="TJS" ) selected @endif>
                                                TJS</option>
                                            <option value="TMT" @if(config('setting.currencyId')=="TMT" ) selected @endif>
                                                TMT</option>
                                            <option value="TND" @if(config('setting.currencyId')=="TND" ) selected @endif>
                                                TND</option>
                                            <option value="TOP" @if(config('setting.currencyId')=="TOP" ) selected @endif>
                                                TOP</option>
                                            <option value="TRY" @if(config('setting.currencyId')=="TRY" ) selected @endif>
                                                TRY</option>
                                            <option value="TTD" @if(config('setting.currencyId')=="TTD" ) selected @endif>
                                                TTD</option>
                                            <option value="TWD" @if(config('setting.currencyId')=="TWD" ) selected @endif>
                                                TWD</option>
                                            <option value="TZS" @if(config('setting.currencyId')=="TZS" ) selected @endif>
                                                TZS</option>
                                            <option value="UAH" @if(config('setting.currencyId')=="UAH" ) selected @endif>
                                                UAH</option>
                                            <option value="UGX" @if(config('setting.currencyId')=="UGX" ) selected @endif>
                                                UGX</option>
                                            <option value="USD" @if(config('setting.currencyId')=="USD" ) selected @endif>
                                                USD</option>
                                            <option value="USN" @if(config('setting.currencyId')=="USN" ) selected @endif>
                                                USN</option>
                                            <option value="UYI" @if(config('setting.currencyId')=="UYI" ) selected @endif>
                                                UYI</option>
                                            <option value="UYU" @if(config('setting.currencyId')=="UYU" ) selected @endif>
                                                UYU</option>
                                            <option value="UZS" @if(config('setting.currencyId')=="UZS" ) selected @endif>
                                                UZS</option>
                                            <option value="VEF" @if(config('setting.currencyId')=="VEF" ) selected @endif>
                                                VEF</option>
                                            <option value="VND" @if(config('setting.currencyId')=="VND" ) selected @endif>
                                                VND</option>
                                            <option value="VUV" @if(config('setting.currencyId')=="VUV" ) selected @endif>
                                                VUV</option>
                                            <option value="WST" @if(config('setting.currencyId')=="WST" ) selected @endif>
                                                WST</option>
                                            <option value="XAF" @if(config('setting.currencyId')=="XAF" ) selected @endif>
                                                XAF</option>
                                            <option value="XCD" @if(config('setting.currencyId')=="XCD" ) selected @endif>
                                                XCD</option>
                                            <option value="XDR" @if(config('setting.currencyId')=="XDR" ) selected @endif>
                                                XDR</option>
                                            <option value="XOF" @if(config('setting.currencyId')=="XOF" ) selected @endif>
                                                XOF</option>
                                            <option value="XPF" @if(config('setting.currencyId')=="XPF" ) selected @endif>
                                                XPF</option>
                                            <option value="XSU" @if(config('setting.currencyId')=="XSU" ) selected @endif>
                                                XSU</option>
                                            <option value="XUA" @if(config('setting.currencyId')=="XUA" ) selected @endif>
                                                XUA</option>
                                            <option value="YER" @if(config('setting.currencyId')=="YER" ) selected @endif>
                                                YER</option>
                                            <option value="ZAR" @if(config('setting.currencyId')=="ZAR" ) selected @endif>
                                                ZAR</option>
                                            <option value="ZMW" @if(config('setting.currencyId')=="ZMW" ) selected @endif>
                                                ZMW</option>
                                            <option value="ZWL" @if(config('setting.currencyId')=="ZWL" ) selected @endif>
                                                ZWL</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="currencyFormat"
                                            value="{{ config('setting.currencyFormat') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="currencySymbolAlign" class="form-control form-control-lg select">
                                            <option value="left" @if(config('setting.currencySymbolAlign')=="left" ) selected
                                                @endif>Left
                                            </option>
                                            <option value="right" @if(config('setting.currencySymbolAlign')=="right" ) selected
                                                @endif>Right
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="walletName"
                                            value="{{ config('setting.walletName') }}"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Minimum Payout for Store in
                                            {{ config('setting.currencyFormat') }}: </strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg min-payout" name="minPayout"
                                            value="{{ config('setting.minPayout') }}"
                                            placeholder="Minimum Payout for Store in {{ config('setting.currencyFormat') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg threshold-time"
                                            ...
                                            value="{{ config('setting.restaurantAcceptTimeThreshold') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg threshold-time"
                                            ...
                                            value="{{ config('setting.deliveryAcceptTimeThreshold') }}">
                                        <span class="help-text small">Maximum time in minutes after which admin
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="uploadImageQuality" class="form-control form-control-lg select">
                                            <option value="25" @if(config('setting.uploadImageQuality')=="25" ) selected @endif>
                                                Low</option>
                                            <option value="50" @if(config('setting.uploadImageQuality')=="50" ) selected @endif>
                                                Medium</option>
                                            <option value="75" @if(config('setting.uploadImageQuality')=="75" ) selected @endif>
                                                Standard</option>
                                            <option value="100" @if(config('setting.uploadImageQuality')=="100" ) selected
                                                @endif>Best</option>
                                        </select>
                                        <span class="help-text small">Only for Items upload via Admin and Store
                                            Dashboard.</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Wait for Awaiting Payment
                                            for: <i class="icon-question3 ml-1" data-popup="tooltip"
                                                title="The status of the Order with Awaiting Payment status will be changed to Payment Failed (Cronjob Setup Required)"
                                                data-placement="top"></i> </strong></label>
                                    <div class="col-lg-9">
                                        <select name="awaitingPaymentThreshold" class="form-control form-control-lg select">
                                            <option value="5" @if(config('setting.awaitingPaymentThreshold')=="5" ) selected
                                                @endif>
                                                5 Minutes</option>
                                            <option value="10" @if(config('setting.awaitingPaymentThreshold')=="10" ) selected
                                                @endif>
                                                10 Minutes</option>
                                            <option value="15" @if(config('setting.awaitingPaymentThreshold')=="15" ) selected
                                                @endif>
                                                15 Minutes</option>
                                            <option value="20" @if(config('setting.awaitingPaymentThreshold')=="20" ) selected
                                                @endif>20 Minutes</option>
                                            <option value="25" @if(config('setting.awaitingPaymentThreshold')=="25" ) selected
                                                @endif>25 Minutes</option>
                                            <option value="30" @if(config('setting.awaitingPaymentThreshold')=="30" ) selected
                                                @endif>30 Minutes</option>
                                            <option value="45" @if(config('setting.awaitingPaymentThreshold')=="45" ) selected
                                                @endif>45 Minutes</option>
                                            <option value="60" @if(config('setting.awaitingPaymentThreshold')=="60" ) selected
                                                @endif>60 Minutes</option>
                                        </select>
                                        <span class="help-text small text-danger">Cronjob setup is require. 
                                            {{-- <a href="https://docs.foodomaa.com/configurations/store-scheduling-open-close-times" target="_blank">Watch Video</a> --}}
                                        </span>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Allow Payment Gateway Selection for Store
                                            Owners <i class="icon-question3 ml-1" data-popup="tooltip"
                                                title="Enabling this will allow the Store Owners to enable payment gateways of their choice from the list of active payment gateways."
                                                data-placement="top"></i></strong> </label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    ...
                                                    checked="checked" @endif name="allowPaymentGatewaySelection">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Daily Revenue Target
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg daily-rev-target"
                                            name="adminDailyTargetRevenue"
                                            value="{{ config('setting.adminDailyTargetRevenue') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enDevMode')=="true" ) checked="checked" @endif
                                                    name="enDevMode">
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="seoMetaTitle"
                                            value="{{ config('setting.seoMetaTitle') }}" placeholder="Meta Title">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="seoMetaDescription"
                                            value="{{ config('setting.seoMetaDescription') }}" placeholder="Meta Description">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="seoOgTitle"
                                            value="{{ config('setting.seoOgTitle') }}" placeholder="Open Graph Title">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="seoOgDescription"
                                            value="{{ config('setting.seoOgDescription') }}"
                                            placeholder="Open Graph Meta Description">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    @if(config('setting.seoOgImage') !== NULL)
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/social/{{ config('setting.seoOgImage') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="seoTwitterTitle"
                                            value="{{ config('setting.seoTwitterTitle') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="seoTwitterDescription"
                                            value="{{ config('setting.seoTwitterDescription') }}"
                                            placeholder="Twitter Cards Description">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    @if(config('setting.seoTwitterImage') !== NULL)
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/social/{{ config('setting.seoTwitterImage') }}"
                            ...
                            <div class="tab-pane fade" id="designSettings">
                                ...
                                <div class="form-group row">
                                    @if(config('setting.storeLogo') !== NULL)
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/logos/{{ config('setting.storeLogo') }}"
                                            alt="logo" class="img-fluid mb-2" style="width: 135px;">
                                    </div>
                                    @endif
                                    <label class="col-lg-3 col-form-label"><strong>Logo: </strong></label>
                                    <div class="col-lg-9">
                                        <input type="file" class="form-control-uniform" name="logo" accept="image/x-png"
                                            data-fouc>
                                        <span class="help-text small">Image dimension 320x108 - (PNG image only)</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    @if(config('setting.favicon-32x32') !== NULL)
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/favicons/{{ config('setting.favicon-96x96') }}"
                                            alt="favicon-96x96" class="img-fluid mb-2" style="width: 70px;">
                                    </div>
                                    @endif
                                    <label class="col-lg-3 col-form-label"><strong>Favicon: </strong></label>
                                    <div class="col-lg-9">
                                        <input type="file" class="form-control-uniform" name="favicon" accept="image/x-png"
                                            data-fouc>
                                ...
                                {{-- 
                                <div class="form-group row">
                                    @if(config('setting.splashLogo') !== NULL)
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/assets/img/splash/{{ config('setting.splashLogo') }}"
                                ...
                                <div class="form-group row">
                                    @if(config('setting.firstScreenHeroImage') !== NULL)
                                    <div class="col-lg-9 offset-lg-3">
                                        <img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/{{ config('setting.firstScreenHeroImage') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input" name="storeColor"
                                            data-preferred-format="rgb" value="{{ config('setting.storeColor') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Cart Background
                                            Color:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input" name="cartColorBg"
                                            data-preferred-format="rgb" value="{{ config('setting.cartColorBg') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Cart Text Color:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input" name="cartColorText"
                                            data-preferred-format="rgb" value="{{ config('setting.cartColorText') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>New Item Badge
                                            Color:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input" name="newBadgeColor"
                                            data-preferred-format="rgb" value="{{ config('setting.newBadgeColor') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Popular Item Badge
                                            Color:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input" name="popularBadgeColor"
                                            data-preferred-format="rgb" value="{{ config('setting.popularBadgeColor') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Recommended Item Badge
                                            Color:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input" name="recommendedBadgeColor"
                                            data-preferred-format="rgb" value="{{ config('setting.recommendedBadgeColor') }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enablePushNotification')=="true" ) checked="checked" @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enablePushNotificationOrders')=="true" ) checked="checked" @endif
                                                    name="enablePushNotificationOrders">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="firebaseSenderId"
                                            value="{{ config('setting.firebaseSenderId') }}" placeholder="Enter Firebase Sender ID">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="firebasePublic"
                                            value="{{ config('setting.firebasePublic') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="firebaseSecret"
                                            value="{{ config('setting.firebaseSecret') }}" placeholder="Enter Firebase Secret">
                                        <p class="text-default"><strong>Note: </strong> Do not paste a legacy server key.
                                        </p>
                                    </div>
                                </div>
                                {{-- <span class="help-text"><a href="https://docs.foodomaa.com/configurations/push-notification-keys"
                                        target="_blank">How to configure Push Notifiactions? </a></span>
                                <br>
                                <span><strong class="text-danger">IMPORTANT</strong> To learn how Subscribers, Push
                                    Notifications, and Alerts work <a href="https://docs.foodomaa.com/faqs/push-notifications-and-alerts"
                                        target="_blank"><b>Click Here</b> </a></span> --}}
                                <hr>
                                <div class="mt-4"></div>
                                <legend class="font-weight-semibold text-uppercase font-size-sm">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="oneSignalAppId"
                                            value="{{ config('setting.oneSignalAppId') }}" placeholder="Enter OneSignal App ID">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="oneSignalRestApiKey"
                                            value="{{ config('setting.oneSignalRestApiKey') }}" placeholder="Enter OneSignal Rest API Key">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>New Order Push Notification
                                            Message:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="restaurantNewOrderNotificationMsg"
                                            value="{{ config('setting.restaurantNewOrderNotificationMsg') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enableFacebookLogin')=="true" ) checked="checked" @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="facebookAppId"
                                            value="{{ config('setting.facebookAppId') }}" placeholder="Enter Facebook App ID">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="facebookLoginButtonText"
                                            value="{{ config('setting.facebookLoginButtonText') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enableGoogleLogin')=="true" ) checked="checked" @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="googleAppId"
                                            value="{{ config('setting.googleAppId') }}" placeholder="Enter Google App ID">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="googleLoginButtonText"
                                            value="{{ config('setting.googleLoginButtonText') }}" placeholder="Google Login Button Text">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="mapSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Show Map on Order Tracking
                                            Page?</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showMap')=="true" ) checked="checked" @endif name="showMap">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="googleApiKey"
                                            value="{{ config('setting.googleApiKey') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="googleApiKeyIP"
                                            value="{{ config('setting.googleApiKeyIP') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="googleApiKeyNoRestriction"
                                            placeholder="Google Map API Key which has no IP & HTTP Restrictions"
                                            value="{{ config('setting.googleApiKeyNoRestriction') }}">
                                    </div>
                                </div>

                                <hr>
                                {{-- <a href="https://docs.foodomaa.com/configurations/google-maps-api-keys" target="_blank" rel="nofollow">Click
                                    Here</a>
                                to learn how to setup Google API Keys. --}}
                                <br>
                            </div>
                            <div class="tab-pane fade" id="paymentGatewaySettings">
                                    ...
                                    <div class="col-lg-6 mt-2">
                                        <label>
                                            <input value="{{ $paymentGateway->id }}" type="checkbox"
                                                class="switchery-primary payment-gateway-switch" @if($paymentGateway->is_active
                                            && $activePaymentGatewayCount == 1)
                                            checked="checked"
                                            disabled="disabled"
                                            @endif
                                ...
                                @endforeach
                                <hr>
                                <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/stripe.png" alt="Stripe"
                                        style="width: 35px"> Stripe</h2>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="stripePublicKey"
                                            value="{{ config('setting.stripePublicKey') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="stripeSecretKey"
                                            value="{{ config('setting.stripeSecretKey') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="stripeLocale" class="form-control form-control-lg select">
                                            <option value="auto" @if(config('setting.stripeLocale')=="auto" ) selected @endif>
                                                Stripe detects the langauge of the browser</option>
                                            <option value="cs" @if(config('setting.stripeLocale')=="cs" ) selected @endif>
                                                Czech (Czech Republic)</option>
                                            <option value="da" @if(config('setting.stripeLocale')=="da" ) selected @endif>
                                                Danish</option>
                                            <option value="de" @if(config('setting.stripeLocale')=="de" ) selected @endif>
                                                German (Germany)</option>
                                            <option value="el" @if(config('setting.stripeLocale')=="el" ) selected @endif>
                                                Greek (Greece)</option>
                                            <option value="et" @if(config('setting.stripeLocale')=="et" ) selected @endif>
                                                Estonian (Estonia)</option>
                                            <option value="en" @if(config('setting.stripeLocale')=="en" ) selected @endif>
                                                English</option>
                                            <option value="es" @if(config('setting.stripeLocale')=="es" ) selected @endif>
                                                Spanish (Spain)</option>
                                            <option value="es-419" @if(config('setting.stripeLocale')=="es-419" ) selected @endif>Spanish
                                                (Latin America)</option>
                                            <option value="fi" @if(config('setting.stripeLocale')=="fi" ) selected @endif>
                                                Finnish (Finland)</option>
                                            <option value="fr" @if(config('setting.stripeLocale')=="fr" ) selected @endif>
                                                French (France)</option>
                                            <option value="hu" @if(config('setting.stripeLocale')=="hu" ) selected @endif>
                                                Hungarian (Hungary)</option>
                                            <option value="id" @if(config('setting.stripeLocale')=="id" ) selected @endif>
                                                Indonesian (Indonesia)</option>
                                            <option value="it" @if(config('setting.stripeLocale')=="it" ) selected @endif>
                                                Italian (Italy)</option>
                                            <option value="ja" @if(config('setting.stripeLocale')=="ja" ) selected @endif>
                                                Japanese</option>
                                            <option value="lt" @if(config('setting.stripeLocale')=="lt" ) selected @endif>
                                                Lithuanian (Lithuania)</option>
                                            <option value="lv" @if(config('setting.stripeLocale')=="lv" ) selected @endif>
                                                Latvian (Latvia)</option>
                                            <option value="ms" @if(config('setting.stripeLocale')=="ms" ) selected @endif>
                                                Malay (Malaysia)</option>
                                            <option value="mt" @if(config('setting.stripeLocale')=="mt" ) selected @endif>
                                                Maltese (Malta)</option>
                                            <option value="nb" @if(config('setting.stripeLocale')=="nb" ) selected @endif>
                                                Norwegian Bokmål</option>
                                            <option value="nl" @if(config('setting.stripeLocale')=="nl" ) selected @endif>
                                                Dutch (Netherlands)</option>
                                            <option value="pl" @if(config('setting.stripeLocale')=="pl" ) selected @endif>
                                                Polish (Poland)</option>
                                            <option value="pt-BR" @if(config('setting.stripeLocale')=="pt-BR" ) selected @endif>
                                                Portuguese (Brazil)</option>
                                            <option value="pt" @if(config('setting.stripeLocale')=="pt" ) selected @endif>
                                                Portuguese (Brazil)</option>
                                            <option value="ro" @if(config('setting.stripeLocale')=="ro" ) selected @endif>
                                                Romanian (Romania)</option>
                                            <option value="ru" @if(config('setting.stripeLocale')=="ru" ) selected @endif>
                                                Russian (Russia)</option>
                                            <option value="sk" @if(config('setting.stripeLocale')=="sk" ) selected @endif>
                                                Slovak (Slovakia)</option>
                                            <option value="sl" @if(config('setting.stripeLocale')=="sl" ) selected @endif>
                                                Slovenian (Slovenia)</option>
                                            <option value="sv" @if(config('setting.stripeLocale')=="sv" ) selected @endif>
                                                Swedish (Sweden)</option>
                                            <option value="tk" @if(config('setting.stripeLocale')=="tk" ) selected @endif>
                                                Turkish (Turkey)</option>
                                            <option value="zh" @if(config('setting.stripeLocale')=="zh" ) selected @endif>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Show Stripe Postal Code
                                            Input</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.stripeCheckoutPostalCode')=="true" ) checked="checked" @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.stripeAcceptIdealPayment')=="true" ) checked="checked" @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.stripeAcceptFpxPayment')=="true" ) checked="checked" @endif
                                ...
                                <hr>
                                <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/paypal.png" alt="PayPal"
                                        style="width: 35px"> PayPal</h2>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="paypalEnv" class="form-control form-control-lg select">
                                            <option value="sandbox" @if(config('setting.paypalEnv')=="sandbox" ) selected @endif>Sandbox
                                                (Testing)</option>
                                            <option value="production" @if(config('setting.paypalEnv')=="production" ) selected @endif>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="paypalSandboxKey"
                                            value="{{ config('setting.paypalSandboxKey') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="paypalProductionKey"
                                            value="{{ config('setting.paypalProductionKey') }}"
                                            placeholder="Paypal Production Client Key (Leave blank if not using PayPal)">
                                    </div>
                                </div>
                                <hr>
                                <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/paystack.png"
                                        alt="PayStack" style="width: 35px"> PayStack</h2>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="paystackPublicKey"
                                            value="{{ config('setting.paystackPublicKey') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="paystackPrivateKey"
                                            value="{{ config('setting.paystackPrivateKey') }}"
                                            placeholder="PayStack Private Key (Leave blank if not using PayStack)">
                                    </div>
                                </div>
                                <hr>
                                <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/razorpay.png"
                                        alt="Razorpay" style="width: 35px"> Razorpay</h2>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Razorpay Merchant Id: <i class="icon-question3 ml-1" data-popup="tooltip"
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="razorpayMerchantId"
                                            ...
                                            placeholder="Razorpay Merchant Id (Leave blank if not using Razorpay)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="razorpayKeyId"
                                            value="{{ config('setting.razorpayKeyId') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="razorpayKeySecret"
                                            value="{{ config('setting.razorpayKeySecret') }}"
                                            placeholder="Razorpay Secret Key (Leave blank if not using Razorpay)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Razorpay Webhook Secret:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="razorpayWebhookSecret"
                                            value="{{ config('setting.razorpayWebhookSecret') }}"
                                            placeholder="Razorpay Webhook Secret (Leave blank if not using Razorpay)">
                                        {{-- <p class="mb-0"><a href="https://docs.foodomaa.com/faqs/razorpay-webhooks" target="_blank">Click
                                                here</a> to
                                            learn how to setup Webhooks for Razorpay</p>
                                        <p class="mb-0 text-warning">Webhooks setup is <b>mandatory</b> for Foodomaa <p> --}}
                                    </div>
                                </div>
                                <hr>
                                <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/paymongo.png"
                                        alt="PayMongo" style="width: 35px"> PayMongo</h2>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="paymongoPK"
                                            value="{{ config('setting.paymongoPK') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="paymongoSK"
                                            value="{{ config('setting.paymongoSK') }}"
                                            placeholder="PayMongo Secret Key (Leave blank if not using PayMongo)">
                                    </div>
                                </div>
                                <hr>

                                <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/mercadopago.png"
                                        alt="MercadoPago" style="width: 35px"> MercadoPago</h2>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="mercadopagoAccessToken"
                                            value="{{ config('setting.mercadopagoAccessToken') }}" placeholder="MercadoPago Access Token">
                                        <span class="text-muted">Get Access token from here: <a
                                                href="https://www.mercadopago.com.br/developers/panel/credentials"
                                                target="_blank">https://www.mercadopago.com.br/developers/panel/credentials</a></span>
                                    </div>
                                </div>

                                <hr>

                                <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/paytm.png" alt="Paytm"
                                        style="width: 35px"> Paytm</h2>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="paytm_environment" class="form-control form-control-lg select">
                                            <option @if(config('setting.paytm_environment')=="local" ) selected @endif value="local">Local
                                            </option>
                                            <option @if(config('setting.paytm_environment')=="production" ) selected @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="paytm_merchant_id"
                                            value="{{ config('setting.paytm_merchant_id') }}" placeholder="Paytm Merchant ID">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="paytm_merchant_key"
                                            value="{{ config('setting.paytm_merchant_key') }}" placeholder="Paytm Merchant Key">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="paytm_merchant_website"
                                            value="{{ config('setting.paytm_merchant_website') }}" placeholder="Paytm Website">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="paytm_industry_type"
                                            value="{{ config('setting.paytm_industry_type') }}" placeholder="Paytm Industry Type">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Paytm Channel ID (For
                                            Website):</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="paytm_channel"
                                            value="{{ config('setting.paytm_channel') }}" placeholder="Paytm Channel ID (For Website)">
                                    </div>
                                </div>

                                <hr>
                                <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/flutterwave.png"
                                        alt="Flutterwave" style="width: 35px"> Flutterwave</h2>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="flutterwavePublicKey"
                                            value="{{ config('setting.flutterwavePublicKey') }}" placeholder="Flutterwave Public Key">
                                        <span class="text-muted">How to get the Public Key: <a
                                                href="https://developer.flutterwave.com/docs/api-keys"
                                                target="_blank">https://developer.flutterwave.com/docs/api-keys</a></span><br>
                                        <span class="small text-danger font-weight-bold">Make sure you enable the Test Mode on
                                            Flutterwave dashboard if you intent to use the Test Public Key</span>
                                    </div>
                                </div>

                                <hr>
                                <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/khalti.png" alt="Khalti"
                                        style="width: 35px"> Khalti</h2>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="khaltiPublicKey"
                                            value="{{ config('setting.khaltiPublicKey') }}" placeholder="Khalti Public Key">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="khaltiSecretKey"
                                            value="{{ config('setting.khaltiSecretKey') }}" placeholder="Khalti Secret Key">
                                    </div>
                                </div>
                                <span class="text-muted">How to get the Keys: <a href="https://khalti.com/join/merchant"
                                        target="_blank">https://khalti.com/join/merchant</a></span><br>
                            ...
                            <div class="tab-pane fade" id="smsGatewaySettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="defaultSmsGateway" class="form-control form-control-lg select">
                                            ...
                                            <option @if(config('setting.defaultSmsGateway')==$sms_gateway->id ) selected
                                                @endif value="{{$sms_gateway->id}}">{{$sms_gateway->gateway_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <hr>
                                <div id="msg91Settings" class="@if (config('setting.defaultSmsGateway') != "1") hidden @endif">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="msg91AuthKey"
                                                value="{{ config('setting.msg91AuthKey') }}" placeholder="MSG91 Auth Key">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="msg91SenderId"
                                                value="{{ config('setting.msg91SenderId') }}" placeholder="MSG91 Sender ID">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label"><strong>DLT Template ID for OTP message: (only
                                                for India)</strong></label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="msg91OtpDltTemplateId"
                                                value="{{ config('setting.msg91OtpDltTemplateId') }}"
                                                placeholder="DLT Template ID for OTP message">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label"><strong>DLT Template ID for Store New Order
                                                message: (only for India)</strong></label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="msg91NewOrderDltTemplateId"
                                                value="{{ config('setting.msg91NewOrderDltTemplateId') }}"
                                                placeholder="DLT Template ID for New Order message">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label"><strong>DLT Template ID for Delivery Guy New
                                                Order message: (only for India)</strong></label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg"
                                                name="msg91NewOrderDeliveryDltTemplateId"
                                                value="{{ config('setting.msg91NewOrderDeliveryDltTemplateId') }}"
                                                placeholder="DLT Template ID for New Order message">
                                        </div>
                                    </div>
                                    <p class="text-danger"><b>MSG91</b> requires DLT registation of Sender ID and all the
                                        Messages for sending SMS to India. Contact MSG91 for more info. Or visit: <a
                                            href="https://help.msg91.com/article/348-dlt-registration">https://help.msg91.com/article/348-dlt-registration</a>
                                    </p>
                                    <hr>
                                </div>
                                <div id="twilioSettings" class="@if (config('setting.defaultSmsGateway') != "2") hidden @endif">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="twilioSid"
                                                value="{{ config('setting.twilioSid') }}" placeholder="Twilio SID">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="twilioAccessToken"
                                                value="{{ config('setting.twilioAccessToken') }}" placeholder="Twilio Access Token">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="twilioFromPhone"
                                                value="{{ config('setting.twilioFromPhone') }}" placeholder="Twilio Phone Number">
                                        </div>
                                    </div>
                                    <hr>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Login/Registration Type</strong></label>
                                    <div class="col-lg-9">
                                        <select name="enOLnR" class="form-control form-control-lg select">
                                            <option @if(config('setting.enOLnR')=="true" ) selected @endif value="true">
                                                Phone OTP Login (Recommended)</option>
                                            <option @if(config('setting.enOLnR')=="false" ) selected @endif value="false">
                                                Email/Password Login</option>
                                        </select>
                                    </div>
                                </div>

                                <div class="form-group row @if(config('setting.enOLnR') == "true") hidden @endif" id="enSOVBlock">
                                    <label class="col-lg-3 col-form-label"><strong>OTP Verification on
                                            Registration (for Email/Password Login)</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enSOV')=="true" ) checked="checked" @endif name="enSOV">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="otpMessage"
                                            value="{{ config('setting.otpMessage') }}" placeholder="OTP Message: ">
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>SMS Notification for Store
                                            Owners</strong></label>
                                    <div class="checkbox checkbox-switchery mt-2">
                                        <div class="col-lg-9">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.smsRestaurantNotify')=="true" ) checked="checked" @endif
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Store Owners new order message:
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="defaultSmsRestaurantMsg"
                                            value="{{ config('setting.defaultSmsRestaurantMsg') }}"
                                            placeholder="Store Owners new order message">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class=" col-lg-3 col-form-label"><strong>Include Order Value in the
                                            SMS</strong></label>
                                    <div class="checkbox checkbox-switchery mt-2 ">
                                        <div class="col-lg-9">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.smsRestOrderValue')=="true" ) checked="checked" @endif
                                ...
                                <hr>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>SMS Notification for Delivery
                                            Guys</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.smsDeliveryNotify')=="true" ) checked="checked" @endif
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Delivery Guys new order message:
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="defaultSmsDeliveryMsg"
                                            value="{{ config('setting.defaultSmsDeliveryMsg') }}"
                                            placeholder="Delivery Guys new order message">
                                    </div>
                                </div>
                                <hr>
                                {{-- 
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.smsOrderNotify') == "true" ) checked="checked" @endif
                                            name="smsOrderNotify">
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="emailSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Default Email Gateway</strong></label>
                                    <div class="col-lg-9">
                                        <select name="defaultEmailGateway" class="form-control form-control-lg select">
                                            <option @if(config('setting.defaultEmailGateway')=="sendgrid" ) selected @endif
                                                value="sendgrid">SendGrid</option>
                                            <option @if(config('setting.defaultEmailGateway')=="smtp" ) selected @endif value="smtp">Custom
                                                SMTP</option>
                                        </select>
                                    </div>
                                </div>
                                <hr>
                                <div id="sendgridSettings" class="@if (config('setting.defaultEmailGateway') != "sendgrid") hidden @endif">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="sendgrid_api_key"
                                                value="{{ config('setting.sendgrid_api_key') }}" placeholder="SendGrid API Key">
                                        </div>
                                    </div>
                                </div>
                                <div id="smtpSettings" class="@if (config('setting.defaultEmailGateway') != "smtp") hidden @endif">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="mail_host"
                                                value="{{ config('setting.mail_host') }}" placeholder="SMTP host">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="mail_port"
                                                value="{{ config('setting.mail_port') }}" placeholder="SMTP Port">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="mail_username"
                                                value="{{ config('setting.mail_username') }}" placeholder="SMTP Username">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="mail_password"
                                                value="{{ config('setting.mail_password') }}" placeholder="SMTP Password">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control form-control-lg" name="mail_encryption"
                                                value="{{ config('setting.mail_encryption') }}" placeholder="SMTP Encryption">
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="email" class="form-control form-control-lg" name="sendEmailFromEmailAddress"
                                            value="{{ config('setting.sendEmailFromEmailAddress') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="sendEmailFromEmailName"
                                            value="{{ config('setting.sendEmailFromEmailName') }}"
                                            placeholder="Enter the email address name (Ex: Your website name)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Password Reset Email
                                            "Subject"</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="passwordResetEmailSubject"
                                            value="{{ config('setting.passwordResetEmailSubject') }}"
                                            placeholder="Enter the email subject for password recovery email (Ex: Password Reset)">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Enable Order Invoice Email</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.sendOrderInvoiceOverEmail')=="true" ) checked="checked" @endif
                                                    name="sendOrderInvoiceOverEmail">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Order Invoice Email Subject</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="orderInvoiceEmailSubject"
                                            value="{{ config('setting.orderInvoiceEmailSubject') }}"
                                            placeholder="Order Invoice Email Subject (# Order ID will be automatically be appended at the end)">
                                    </div>
                                </div>

                                <div>
                                    <p><strong class="text-danger">IMPORTANT:</strong> After saving the settings, send a test
                                        mail to your email
                                        address before you enable the Password Reset Functionality
                                    </p>
                                    <button type="button" class="btn btn-primary btn-md" id="toggleSendTestEmail" autocomplete="false"> Send
                                        Test
                                        Email</button>
                                    <div id="sendTestEmailBlock" style="display: none;">
                                        <div class="form-group row">
                                            ...
                                            <button type="button" class="btn btn-primary btn-labeled btn-labeled-left btn-md"
                                                id="sendTestEmailNow">
                                                <b><i class="icon-mail-read ml-1"></i></b>
                                                Send Test Email
                                                <i class="icon-spinner10 spinner ml-1" id="testMailSpinner" style="display: none;"></i>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enPassResetEmail')=="true" ) checked="checked" @endif
                                                    name="enPassResetEmail">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"><span class="font-weight-bold text-danger"> <i
                                                            class="icon-exclamation mr-2"></i> Important Disclaimer</span></h5>
                                            </div>
                                            <div class="modal-body">
                                                <p>
                                                    ...
                                                    <br>
                                                    Sending of emails cannot be guaranteed with the Custom SMTP Gateway settings
                                                    as configurations may vary from server to server.
                                                    <br><br>
                                                    <strong>Any support tickets related to Custom SMTP Gateway issues will be
                                                        <span class="text-danger">closed</span> automatically.</strong>
                                                </p>
                                            </div>
                                            <div class="modal-footer">
                                                <div class="text-right">
                                                    <button type="button" class="btn btn-primary btn-labeled btn-labeled-left btn-lg"
                                                        data-dismiss="modal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enableGoogleAnalytics')=="true" ) checked="checked" @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="googleAnalyticsId"
                                            value="{{ config('setting.googleAnalyticsId') }}" placeholder="UA-00000000-00">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.taxApplicable')=="true" ) checked="checked" @endif
                                                    name="taxApplicable">
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="taxPercentage"
                                            value="{{ config('setting.taxPercentage') }}" placeholder="Tax in Percentage">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="customerAppSettings">
                                ...
                                {{-- <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>I have Foodomaa Customer Android App
                                            <span class="badge badge-flat border-grey-800 text-danger text-capitalize mx-1">NEW</span> <i class="icon-question3 ml-1" data-popup="tooltip"
                                            title="Push notification will not work properly if this config is not correctly set. If you have the Foodomaa Customer Android App, enable this setting, else keep it disabled"
                                            data-placement="top"></i></strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.iHaveFooodmaaAndroidApp')=="true" ) checked="checked" @endif name="iHaveFooodmaaAndroidApp">
                                                    <p class="small mb-0">Make sure to enable this setting if you have purchased the <a href="https://shop.foodomaa.com/store/android-customer-mobile-application" target="_blank">Foodomaa Customer Android App</a></p>
                                                    <p class="small mb-0 text-danger"><strong>DONOT</strong> enable if you have not purchased the app</p>
                                            </label>
                                        </div>
                                    </div>
                                </div> --}}
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Enable COD on Selfpickup
                                            <i class="icon-question3 ml-1" data-popup="tooltip"
                                                title="Cash on Delivery payment gateway is disabled on Selfpickup orders by default. Enabling this option will show Cash On Delivery payment option for Selfpickup orders too."
                                                data-placement="top"></i></strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enCODonSF')=="true" ) checked="checked" @endif name="enCODonSF">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Show Cash Change on COD
                                            <i class="icon-question3 ml-1" data-popup="tooltip"
                                                title="If enabled, on cash on delivery payments, the customer will be asked to enter amount for the cash change they need."
                                                data-placement="top"></i></strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showCashChange')=="true" ) checked="checked" @endif
                                                    name="showCashChange">
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Sort Delivery stores by Distance</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.sortDeliveryStoresByDistance')=="true" ) checked="checked" @endif
                                                    name="sortDeliveryStoresByDistance">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Show PWA Installation Prompt
                                            <i class="icon-question3 ml-1" data-popup="tooltip"
                                                title="This will show the new PWA Installation Prompt above the footer on the Homepage."
                                                data-placement="top"></i></strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showPwaInstallPromptFooter')=="true" ) checked="checked" @endif
                                                    name="showPwaInstallPromptFooter">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showCustomerVatNumber')=="true" ) checked="checked" @endif
                                                    name="showCustomerVatNumber">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showAddonPricesOnCart')=="true" ) checked="checked" @endif
                                                    name="showAddonPricesOnCart">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Show "Try on Phone" on Desktop
                                            View</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showTryItOnPhone')=="true" ) checked="checked" @endif
                                                    name="showTryItOnPhone">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showTipsAmount')=="true" ) checked="checked" @endif
                                                    name="showTipsAmount">
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-3 col-lg-3 col-form-label">
                                        <label><strong>Tip Amount <i class="icon-question3 ml-1" data-popup="tooltip"
                                                    title="Type any amount and hit Enter on your Keyboard" data-placement="top">
                                                </i></strong></label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Enable Delivery Tip
                                            Percentage</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showTipsPercentage')=="true" ) checked="checked" @endif
                                                    name="showTipsPercentage">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3 col-lg-3 col-form-label">
                                        <label><strong>Tip Percentage <i class="icon-question3 ml-1" data-popup="tooltip"
                                                    title="Type any Percentage Amount and hit Enter on your Keyboard" data-placement="top">
                                                </i> </strong></label>
                                    </div>
                                    <div class="col-md-9 tipss">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Show Total Item Quantity on Footer Cart <i
                                                class="icon-question3 ml-1" data-popup="tooltip"
                                                title="If disabled, the count of unique items on the cart will be shown on the footer"
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.countQuantityAsTotalItemsOnCart')=="true" ) checked="checked" @endif
                                                    name="countQuantityAsTotalItemsOnCart">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Auto Full Address on Location Selection Page
                                            <i class="icon-question3 ml-1" data-popup="tooltip"
                                                title="Disabling this will only show locality, city, country and pincode on the auto address box"
                                                data-placement="top"></i>
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.googleFullAddress')=="true" ) checked="checked" @endif
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Search Bar on Homepage <i class="icon-question3 ml-1"
                                                data-popup="tooltip" title="This will override the default coupon success message"
                                                data-placement="top"></i>
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.mockSearchOnHomepage')=="true" ) checked="checked" @endif
                                                    name="mockSearchOnHomepage">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="footerStyleType" class="form-control form-control-lg select">
                                            <option value="FIXED" @if(config('setting.footerStyleType')=="FIXED" ) selected="selected"
                                                @endif>Fixed Style
                                            </option>
                                            <option value="FLOAT" @if(config('setting.footerStyleType')=="FLOAT" ) selected="selected"
                                                @endif>Float Style
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Show Custom iOS Add To Homescreen Popup <i
                                                class="icon-question3 ml-1" data-popup="tooltip"
                                                title="Enabling this will display a custom popup on iOS device for Add To Homescreen once per user, 3 seconds after page is loaded."
                                                data-placement="top"></i>
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enIOSPWAPopup')=="true" ) checked="checked" @endif
                                                    name="enIOSPWAPopup">
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Show Coupon Desctiption on Coupon Success <i
                                                class="icon-question3 ml-1" data-popup="tooltip"
                                                title="This will override the default coupon success message" data-placement="top"></i>
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showCouponDescriptionOnSuccess')=="true" ) checked="checked" @endif
                                                    name="showCouponDescriptionOnSuccess">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Use Google Distance Matrix API <i
                                                class="icon-question3 ml-1" data-popup="tooltip"
                                                title="Google APIs will be used for calculating the delivery charge if the store has enabled Dynamic Delivery charge"
                                                data-placement="top"></i>
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enGDMA')=="true" ) checked="checked" @endif name="enGDMA">
                                                    {{-- <b><span class="mt-1"><span class="text-danger"> IMPORTANT: </span>Donot enable
                                                        Google Distance Matrix API without first follow </span> <a
                                                        href="https://docs.foodomaa.com/configurations/google-distance-matrix-api"
                                                        target="_blank"> this documentation.</a><br>You will get a loading screen on the Cart page if this documentation is not followed.
                                                    </b> --}}
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Randomize Stores
                                            <i class="icon-question3 ml-1" data-popup="tooltip"
                                                title="Delivery and Selfpickup stores will be randomized (Sorting order will be ignored) - Postion of the stores on back button press will be changed - So enabling this is NOT Recommended for better User Experience"
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.randomizeStores')=="true" ) checked="checked" @endif
                                                    name="randomizeStores">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Show Inactive Items
                                            <i class="icon-question3 ml-1" data-popup="tooltip"
                                                title="Inactive items will be displayed but Add to Cart button will not be shown"
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showInActiveItemsToo')=="true" ) checked="checked" @endif
                                                    name="showInActiveItemsToo">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.flatApartmentAddressRequired')=="true" ) checked="checked" @endif
                                                    name="flatApartmentAddressRequired">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enableDeliveryPin')=="true" ) checked="checked" @endif
                                                    name="enableDeliveryPin">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showPromoSlider')=="true" ) checked="checked" @endif
                                                    name="showPromoSlider">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showVegNonVegBadge')=="true" ) checked="checked" @endif
                                                    name="showVegNonVegBadge">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showFromNowDate')=="true" ) checked="checked" @endif
                                                    name="showFromNowDate">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enDelChrRnd')=="true" ) checked="checked" @endif name="enDelChrRnd">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.recommendedLayoutV2')=="true" ) checked="checked" @endif
                                                    name="recommendedLayoutV2">
                                            </label>
                                        </div>
                                    </div>
                                </div>  
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.expandAllItemMenu')=="true" ) checked="checked" @endif
                                                    name="expandAllItemMenu">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showGdpr')=="true" ) checked="checked" @endif name="showGdpr">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enSPU')=="true" ) checked="checked" @endif name="enSPU">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Sort Self Pickup stores by
                                            Distance</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.sortSelfpickupStoresByDistance')=="true" ) checked="checked" @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="phoneCountryCode"
                                            value="{{ config('setting.phoneCountryCode') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.hidePriceWhenZero')=="true" ) checked="checked" @endif
                                                    name="hidePriceWhenZero">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showPercentageDiscount')=="true" ) checked="checked" @endif
                                                    name="showPercentageDiscount">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.useSimpleSpinner')=="true" ) checked="checked" @endif
                                                    name="useSimpleSpinner">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="deliveryAppSettings">
                                ...
                                {{-- <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>I have Foodomaa Delivery Android App
                                        <span class="badge badge-flat border-grey-800 text-danger text-capitalize mx-1">NEW</span> <i class="icon-question3 ml-1" data-popup="tooltip"
                                        title="Push notification will not work properly if this config is not correctly set. If you have the Foodomaa Delivery App, enable this setting, else keep it disabled"
                                        data-placement="top"></i></strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.iHaveFooodmaaDeliveryApp')=="true" ) checked="checked" @endif name="iHaveFooodmaaDeliveryApp">
                                                    <p class="small mb-0">Make sure to enable this setting if you have purchased the <a href="https://shop.foodomaa.com/store/android-delivery-mobile-application" target="_blank">Foodomaa Delivery Android App</a></p>
                                                    <p class="small mb-0 text-danger"><strong>DONOT</strong> enable if you have not purchased the app</p>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.enableDeliveryGuyEarning')=="true" ) checked="checked" @endif
                                                    name="enableDeliveryGuyEarning">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="deliveryGuyCommissionFrom" class="form-control form-control-lg select">
                                            <option value="FULLORDER" @if(config('setting.deliveryGuyCommissionFrom')=="FULLORDER" )
                                                selected="selected" @endif>Commission from Full Order Value
                                            </option>
                                            <option value="DELIVERYCHARGE" @if(config('setting.deliveryGuyCommissionFrom')=="DELIVERYCHARGE"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="checkbox checkbox-switchery mt-2">
                                                <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                @if(config('setting.showDeliveryFullAddressOnList')=="true" ) checked="checked"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showUserInfoBeforePickup')=="true" ) checked="checked" @endif
                                                    name="showUserInfoBeforePickup">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showOrderAddonsDelivery')=="true" ) checked="checked" @endif
                                                    name="showOrderAddonsDelivery">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showPriceAndOrderCommentsDelivery')=="true" ) checked="checked"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.showDeliveryCollection')=="true" ) checked="checked" @endif
                                                    name="showDeliveryCollection">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <p><strong class="text-danger">Important Note: </strong> You will need to logout of the delivery
                                    application and login again to get the updated congigs/settings.</p>
                            </div>
                            <div class="tab-pane fade" id="restaurantDashboardSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Hide Customer Details on Order
                                        <span class="badge badge-flat border-grey-800 text-danger text-capitalize mx-1">NEW</span></strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if(config('setting.hideCustomerDetailsFromStoreOwner')=="true" ) checked="checked" @endif
                                                    name="hideCustomerDetailsFromStoreOwner">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="restaurantNewOrderRefreshRate" class="form-control form-control-lg select">
                                            <option value="5" @if(config('setting.restaurantNewOrderRefreshRate')=="5" ) selected @endif>
                                                Fetch Every 5 Seconds</option>
                                            <option value="15" @if(config('setting.restaurantNewOrderRefreshRate')=="15" ) selected @endif>
                                                Fetch Every 15 Seconds</option>
                                            <option value="25" @if(config('setting.restaurantNewOrderRefreshRate')=="25" ) selected @endif>
                                                Fetch Every 25 Seconds</option>
                                            <option value="30" @if(config('setting.restaurantNewOrderRefreshRate')=="30" ) selected @endif>
                                                Fetch Every 30 Seconds</option>
                                        </select>
                                        <span class="help-text small mt-2"> The lesser the value, the more load on the server.
                                            Recommended is <strong>15 Seconds </strong></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Notification Tone:</strong></label>
                                    <div class="col-lg-9">
                                        <select name="restaurantNotificationAudioTrack" class="form-control form-control-lg select"
                                            id="restaurantNotificationTone">
                                            @foreach($notificationAudioFileNames as $audioFileName)
                                            <option value="{{ $audioFileName }}"
                                                @if(config('setting.restaurantNotificationAudioTrack')==$audioFileName) selected @endif>
                            ...
                            <div class="tab-pane fade" id="customCSS">
                                ...
                                <div id="css_editor1">{{ config('setting.customCSS') }}</div>
                                <textarea style="display: none" class="form-control" name="customCSS" rows="5"
                                    placeholder="Your CSS code goes here...">{{ config('setting.customCSS') }}</textarea>

                                <hr>

                                <p>Below code will affect the styling for the Admin/Store Dashboard
                                </p>
                                <div id="css_editor2">{{ config('setting.adminCustomCss') }}</div>
                                <textarea style="display: none" class="form-control" name="adminCustomCss" rows="5"
                                    placeholder="Your CSS code goes here...">{{ config('setting.adminCustomCss') }}</textarea>
                            ...
                            <div class="tab-pane fade" id="cacheSettings">
                                ...
                                <div class="row">
                                    ...
                                    <span class="col-md-6 col-xs-12"
                                        id="cacheVersion">{{ implode('-', str_split($versionJson->forceCacheClearVersion, 5)) }}</span>
                                </div>
                                <div class="row">
                                    <p class="col-md-3 col-xs-12"><strong>Settings Hash: </strong></p>
                                    <span class="col-md-6 col-xs-12"
                                        id="settingsVersion">{{ implode('-', str_split($versionJson->forceNewSettingsVersion, 5)) }}</span>
                                </div>
                                {{-- 
                                <div class="row">
                                ...
                                <a href="javascript:void(0)" data-type="CACHE" data-popup="tooltip" title="Double Click to Execute"
                                    data-placement="right" class="btn btn-secondary btn-labeled btn-labeled-left" id="forceClearCache"> <b><i
                                ...
                                <a href="javascript:void(0)" data-type="SETTINGS" data-popup="tooltip" title="Double Click to Execute"
                                    data-placement="right" class="btn btn-secondary btn-labeled btn-labeled-left" id="forceClearSettings">
                            ...
                            <div class="tab-pane fade" id="fixUpdateIssues">
                                ...
                                <a href="{{ route('admin.fixUpdateIssues') }}" class="btn btn-lg btn-primary" id="fixUpdateIssuesButton">Fix
                                    Issues Now</a>
                            </div>
                            <div class="tab-pane fade" id="advanceSettings">
                                ...
                                <button type="button" class="btn btn-danger btn-labeled btn-labeled-left" data-popup="tooltip"
                                    title="On click of this button, you will be asked to confirm this action." data-placement="right">
                                ...
                                <div class="mt-4">
                                    <p class="text-danger mb-2"><strong>EXPERIMENTAL FEATURE </strong> - no guarantee of work</p>
                                    <a href="{{ route('admin.filesBackup') }}" class="btn btn-info btn-labeled btn-labeled-left backupBtn mr-2">
                                        <b><i class="icon-folder-download2"></i></b>
                                        Files Backup
                                    </a>
                                    <a href="{{ route('admin.dbBackup') }}" class="btn btn-info btn-labeled btn-labeled-left backupBtn">
                                        <b><i class="icon-database-time2"></i></b>
                                        Database Backup
                                    </a>
                                    <p class="mt-2"> Please note the backup feature is experimental and the backup doesn't work on all
                                        the servers (even if a success message is returned). We will be improving this in the future
                                        releases if feasible or this module could be removed in the future releases.</p>
                                </div>
                                {{-- <hr class="mt-4"> --}}
                                {{-- <div class="mt-4">
                                    <a href="{{ route('admin.utility.index') }}" class="btn btn-info btn-labeled btn-labeled-left mr-2">
                                        <b><i class="icon-hammer-wrench"></i></b>
                                        Foodomaa Utilities
                                    </a>
                                </div> --}}
                                <hr class="mt-4">
                                <div class="mt-4">
                                    <a href="{{ route('licenseManager') }}" class="btn btn-info btn-labeled btn-labeled-left mr-2"
                                        target="_blank">
                                        <b><i class="icon-certificate"></i></b>
                                        License Manager
                                    </a>
                                </div>
                                <hr class="mt-4">
                                <div class="mt-4">
                                    <button class="btn btn-danger btn-labeled btn-labeled-left mr-2" data-popup="tooltip"
                                        title="On click of this button, you will be asked to confirm this action." data-placement="right"
                                        type="button">
                                        <b><i class="icon-trash"></i></b>
                                        <span data-toggle="modal" data-target="#cleanActivityJunk">Clean Order Activity Logs</span>
                                    </button>
                                </div>
                            </div>
                            <div id="cleanEverything" class="modal fade" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title"><span class="font-weight-bold text-danger"> <i
                                                        class="icon-exclamation mr-2"></i> This is an irreversible action.</span></h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <i class="icon-spinner10 spinner text-warning ml-2 float-right hidden" id="cleanSpinner"
                                                style="font-size: 2.5rem;"></i>
                                            <button type="button" class="btn btn-lg btn-danger float-right btn-labeled btn-labeled-left"
                                                disabled="disabled" id="cleanEverythingButton">
                            ...
                            <div id="cleanActivityJunk" class="modal fade" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title"><span class="font-weight-bold text-danger"> <i
                                        ...
                                        <div class="modal-body">
                                            <p>Order activity logs older than <b>30 days</b> will be deleted</p>
                                            <p> <b>Note: </b>
                                                <span class="text-danger"><b>DONOT</b> close this window or reload during the cleaning
                                                    process. </span></p>
                                            <a href="{{ route('admin.deleteJunkActivityLogs') }}" class="btn btn-lg btn-danger d-block mt-3">
                                                Proceed to Clean
                                            </a>
                                        </div>
                                    </div>
...
<script>
    $(function() {
       ...
       $(document).on('keypress', '.tipss .select2-search__field', function () {
        ...
        var css_editor2 = ace.edit("css_editor2");
        css_editor2.setTheme("ace/theme/textmate");
        css_editor2.getSession().setMode("ace/mode/css");
        css_editor2.setShowPrintMargin(false);
    
        var customCSS2 = $('textarea[name="adminCustomCss"]');
        css_editor2.getSession().on("change", function () {
            customCSS2.val(css_editor2.getSession().getValue());
        });
        ...
        $('.daily-rev-target').numeric({allowThouSep:false, allowDecSep:true, allowMinus: false, maxDigits: 20, maxDecimalPlaces: 2});
        ...
        $("[name='enOLnR']").change(function() {
            let selectType = $(this).val();
            if (selectType == "true") {
                $('#enSOVBlock').addClass('hidden');
            } 
            if (selectType == "false") {
                $('#enSOVBlock').removeClass('hidden');
            } 
        });
