                        ...
                        <ul class="nav nav-pills flex-column mr-lg-3 wmin-lg-250 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a href="#operationAreaSettings" class="nav-link" data-toggle="tab">
                                    ...
                                    Operation Area @if(isset($navZones) && count($navZones) > 0) & Zone @endif
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            ...
                            <div class="tab-pane fade show active" id="generalSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Store
                                        Name:</label>
                                    <div class="col-lg-9">
                                        <input value="{{ $restaurant->name }}" type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select multiple="multiple" class="form-control selectRestaurantCategory"
                                            ...
                                            <option value="{{ $rC->id }}" class="text-capitalize"
                                                {{isset($restaurant) &&  in_array($restaurant->id, $rC->restaurants()->pluck('restaurant_id')->toArray()) ? 'selected' : '' }}>
                                                {{ $rC->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Store
                                        URL</label>
                                    <div class="col-lg-9">
                                        <input value="{{ $restaurant->slug }}" type="text"
                                            class="form-control form-control-lg" name="store_url"
                                            placeholder="Store URL" required>
                                        <p onclick="copyURL()" class="text-muted">
                                            https://{{ request()->getHttpHost() }}/stores/<strong><span
                                                    id="storeURL">{{ $restaurant->slug }}</span></strong></p>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="metaDataSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input value="{{ $restaurant->rating }}" type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea class="summernote-editor" name="custom_message_on_list"
                                            ...
                                            rows="6">{{ $restaurant->custom_message_on_list }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea class="summernote-editor" name="custom_message"
                                            ...
                                            rows="6">{{ $restaurant->custom_message }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="zone_id" class="select-zone" required>
                                            ...
                                            <option value="{{ $zone->id }}" @if($restaurant->zone_id == $zone->id)
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label class="col-form-label">Latitude:</label><input type="text"
                                                ...
                                                value="{{ $restaurant->latitude }}" required="required"
                                                readonly="readonly">
                                        </div>
                                        <div class="col-lg-6">
                                            <label class="col-form-label">Longitude:</label><input type="text"
                                                ...
                                                value="{{ $restaurant->longitude }}" required="required"
                                                readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" value="{{ $restaurant->delivery_radius }}"
                                                ...
                                                @if($dapCheck && count($restaurant->delivery_areas) > 0)
                                            disabled="disabled" style="cursor: not-allowed;" title="Radius is ignored
                                            when areas are assigned to store." @endif>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="my-2">
                                                ...
                                                <span class="badge badge-flat border-grey-800 mr-1 mb-2"
                                                    style="font-size: 0.9rem;">{{ $deliveryArea->name }}</span>
                                                @endforeach
                                            </div>
                                            <a href="{{ route('dap.assignAreasToStore', $restaurant->id) }}"
                                                class="btn btn-md btn-secondary">Manage Areas</a>
                                            @else
                                            <p class="text-warning mb-0 my-2" style="line-height: 2.4rem;">
                                                <b>{{ $restaurant->name }}</b> is not assigned to any area for
                                                operation.</p>
                                            <a href="{{ route('dap.assignAreasToStore', $restaurant->id) }}"
                            ...
                            <div class="tab-pane fade" id="deliverySettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control select" name="delivery_type" required>
                                            <option value="1" class="text-capitalize" @if($restaurant->delivery_type ==
                                                "1") selected="selected" @endif>Delivery</option>
                                            <option value="2" class="text-capitalize" @if($restaurant->delivery_type ==
                                                "2") selected="selected" @endif>Self Pickup</option>
                                            <option value="3" class="text-capitalize" @if($restaurant->delivery_type ==
                                                "3") selected="selected" @endif>Both Delivery & Self Pickup</option>
                                        </select>
                                    </div>
                                </div>
                                @endif
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control select" name="delivery_charge_type" required>
                                            <option value="FIXED" @if($restaurant->delivery_charge_type == "FIXED")
                                                selected="selected" @endif class="text-capitalize">Fixed Charge</option>
                                            <option value="DYNAMIC" @if($restaurant->delivery_charge_type == "DYNAMIC")
                                                selected="selected" @endif class="text-capitalize">Dynamic Charge
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row" id="deliveryCharge">
                                    ...
                                    <div class="col-lg-9">
                                        <input value="{{ $restaurant->delivery_charges }}" type="text"
                                        ...
                                        <div class="col-lg-12 row p-0">
                                            <div class="col-lg-3">
                                                <label class="col-lg-12 col-form-label p-0 pb-1">Base Delivery
                                                    Charge:</label>
                                                <input value="{{ $restaurant->base_delivery_charge }}" type="text"
                                            ...
                                            <div class="col-lg-3">
                                                <label class="col-lg-12 col-form-label p-0 pb-1">Base Delivery
                                                    Distance:</label>
                                                <input value="{{ $restaurant->base_delivery_distance }}" type="text"
                                            ...
                                            <div class="col-lg-3">
                                                <label class="col-lg-12 col-form-label p-0 pb-1">Extra Delivery
                                                    Charge:</label>
                                                <input value="{{ $restaurant->extra_delivery_charge }}" type="text"
                                            ...
                                            <div class="col-lg-3">
                                                <label class="col-lg-12 col-form-label p-0 pb-1">Extra Delivery
                                                    Distance:</label>
                                                <input value="{{ $restaurant->extra_delivery_distance }}" type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input value="{{ $restaurant->free_delivery_subtotal }}" type="text"
                                            class="form-control form-control-lg free_delivery_subtotal"
                                            name="free_delivery_subtotal"
                                            placeholder="Free delivery on/above subtotal {{ config('setting.currencyFormat') }}">
                            ...
                            <div class="tab-pane fade" id="extraSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if($restaurant->is_pureveg) checked="checked" @endif
                                                name="is_pureveg">
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if($restaurant->is_featured) checked="checked" @endif
                                                name="is_featured">
                                            </label>
                                        </div>
                                ...
                                <div class="form-group row @if($restaurant->custom_featured_name == null) hidden @endif"
                                    id="customFeaturedBadgeInput">
                                    <label class="col-lg-3 col-form-label">Custom name for Featured Badge</label>
                                    <div class="col-lg-9">
                                        <input value="{{ $restaurant->custom_featured_name }}" type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if($restaurant->auto_acceptable) checked="checked" @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if($restaurant->is_notifiable) checked="checked" @endif
                                                name="is_notifiable">
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="commissionSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Commission
                                        Rate %:</label>
                                    <div class="col-lg-9">
                                        <input value="{{ $restaurant->commission_rate }}" type="text"
